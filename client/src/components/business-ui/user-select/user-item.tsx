...
import type { User } from '@client/src/components/business-ui/user-select/types';
...
export const UserItem = ({
  ...
  const displayName = user?.name?.zh_cn || user?.name?.en_us || '';
  const isExternalUser = user?.userType === '_externalUser';
