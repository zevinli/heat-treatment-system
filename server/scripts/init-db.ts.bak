...
async function main() {
  ...
  const tables = `
    ...
    CREATE TABLE IF NOT EXISTS statistics_daily (
      ...
      total_inbound_count INTEGER DEFAULT 0,
      total_inbound_weight DOUBLE PRECISION DEFAULT 0,
      total_inbound_amount DOUBLE PRECISION DEFAULT 0,
      total_outbound_count INTEGER DEFAULT 0,
      total_outbound_weight DOUBLE PRECISION DEFAULT 0,
      total_outbound_amount DOUBLE PRECISION DEFAULT 0,
      total_receipt_amount DOUBLE PRECISION DEFAULT 0,
      total_invoice_amount DOUBLE PRECISION DEFAULT 0,
      top_customer JSONB,
      top_product JSONB,
      _created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
      _created_by VARCHAR(255),
